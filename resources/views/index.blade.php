                    ...
                    <div class="row align-items-center slider-animated-1">
                        <div class="col-lg-5 col-md-6">
                            <div class="hero-slider-content-2">
                                <h2 class="animated fw-900">{{ $item->text_one }}</h2>
                                <h1 class="animated fw-900 text-brand">{{ $item->text_two }}</h1>
                                <p class="animated">{{ $item->paragraph }}</p>
                            </div>
                        </div>
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <button class="active nav-link" id="nav-tab-three" data-bs-toggle="tab"
                            data-bs-target="#tab-three" type="button">
                            @lang('messages.new')
                        </button>
                    </li>
                </ul>
